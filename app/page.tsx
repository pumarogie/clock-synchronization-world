      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto">
            ...
            <span className="text-cyan-400 font-medium"> NTP-style algorithms</span> and 
            <span className="text-purple-400 font-medium"> real-time WebSockets</span>
          </p>
        </motion.header>
        ...
        >
          ...
          {activeTab === 'visualize' && (
            <SyncTimeline 
              lastMeasurement={timeSync.syncHistory[timeSync.syncHistory.length - 1] || null} 
            />
          )}
        ...
        >
          <p className="mb-3">
            Open multiple browser tabs to see real-time multi-user synchronization
          </p>
